...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="p-4 max-w-sm mx-auto flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <p className="text-slate-300 mb-6 text-center">Please enter the password to manage alerts.</p>
      <div className="w-full bg-brand-navy-light rounded-xl shadow-lg p-6">
